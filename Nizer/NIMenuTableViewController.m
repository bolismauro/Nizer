...
#import "NIMenuTableViewController.h"

#import "UIViewController+REFrostedViewController.h"
#import "NICameraViewController.h"

@interface NIMenuTableViewController ()

@end

@implementation NIMenuTableViewController
- (void)viewDidLoad
{
    [super viewDidLoad];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UINavigationController *navigationController = (UINavigationController *)self.frostedViewController.contentViewController;
    NICameraViewController* controller = [self.storyboard instantiateViewControllerWithIdentifier:@"cameraController"];
